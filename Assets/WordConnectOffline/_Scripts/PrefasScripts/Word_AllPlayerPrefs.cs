...
{
    public static class Word_AllPlayerPrefs
    {
#if !UNITY_WSA
        ...
        {
            //return null;
            return WordConnectPlayerPrefs.Helper.EncryptString(data, getEncryptionPassword(cKey));
        }

        private static string decrypt(string cKey)
        {
            //return null;
            return WordConnectPlayerPrefs.Helper.DecryptString(PlayerPrefs.GetString(cKey), getEncryptionPassword(cKey));
        }
        ...
        public static string hashSum(string strToEncrypt)
        {
            ...
            byte[] hashBytes = WordConnectPlayerPrefs.Helper.hashBytes(bytes);
