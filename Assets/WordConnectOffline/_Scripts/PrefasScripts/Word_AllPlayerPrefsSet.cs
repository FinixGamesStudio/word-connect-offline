...
{
    public class Word_AllPlayerPrefsSet
    {
        ...
        public static bool SetBool(String name, bool value)
        {
            try
            {
                Word_AllPlayerPrefs.SetInt(name, value ? 1 : 0);
            }
            catch
            {
                return false;
        ...
        {
            return Word_AllPlayerPrefs.GetInt(name) == 1;
        }
        ...
        {
            if (Word_AllPlayerPrefs.HasKey(name))
            {
                return GetBool(name);
            }
            return defaultValue;
        ...
        {
            if (Word_AllPlayerPrefs.HasKey(key))
            {
        ...
        public static bool[] GetBoolArray(String key)
        {
            if (Word_AllPlayerPrefs.HasKey(key))
            {
                var bytes = System.Convert.FromBase64String(Word_AllPlayerPrefs.GetString(key));
                if (bytes.Length < 6)
                {
        ...
        public static bool SetStringArray(String key, String[] stringArray)
        {
            ...
            try
            {
                Word_AllPlayerPrefs.SetString(key, System.Convert.ToBase64String(bytes) + "|" + String.Join("", stringArray));
            }
            catch
            {
                return false;
        ...
        public static String[] GetStringArray(String key)
        {
            if (Word_AllPlayerPrefs.HasKey(key))
            {
                var completeString = Word_AllPlayerPrefs.GetString(key);
        ...
        private static bool SaveBytes(String key, byte[] bytes)
        {
            try
            {
                Word_AllPlayerPrefs.SetString(key, System.Convert.ToBase64String(bytes));
            }
            catch
            {
                return false;
