...
{
    public class Word_LineDrawer : MonoBehaviour
    {
        ...
        //public static Word_LineDrawer instance;
        ...
        private void Update()
        {
            ...
            if (Word_MainController.instance.isDialogActive) return;
            ...
            else if (Input.GetMouseButtonUp(0))
            {
                ...
                Word_MainController.instance.wordRegion.CheckAnswer(textPreview.GetText());
            }
