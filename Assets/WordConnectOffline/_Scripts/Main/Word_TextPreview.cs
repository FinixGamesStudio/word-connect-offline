...
{
    public class Word_TextPreview : MonoBehaviour
    {
        ...
        //public static Word_TextPreview instance;
        ...
        public void SetIndexes(List<int> indexes)
        {
            ...
            if (!ConfigController.instance.config.isWordRightToLeft)
            {
            ...
            backgroundRT.sizeDelta = new Vector2(textRT.GetComponent<Text>().preferredWidth + 110, backgroundRT.sizeDelta.y);
        }
